...
- [ ] Confirm README and docs say RunWitness is an alpha foundation, not a hard OS sandbox.
...
- [ ] Do not publish npm packages until package metadata, `files`, access settings, provenance, and release automation are reviewed.
...
- [ ] Open issues for native adapters, OS sandbox runners, hosted auth/RBAC, and universal skill broker integration.
